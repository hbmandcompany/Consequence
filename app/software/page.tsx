...
export const metadata: Metadata = {
  title: "consequence.software — The engine",
  description:
    "Real-time consequence engine. Inference, simulation, and digital twins on Kubernetes-native infrastructure. Built by Hated By Many.",
};
...
function PillarRow({ p, index }: { p: any; index: number }) {
  return (
    <div id={p.id} className="grid grid-cols-12 gap-y-8 gap-x-8 bg-snow-0 border border-ink/10 p-8 lg:p-12 hover:border-ink/30 transition-colors duration-700">
...
function Architecture() {
  return (
    <Section id="architecture" className="py-32 border-t border-ink/10 bg-snow-100">
      <Container>
...
function CTA() {
  return (
    <Section id="contact" className="py-32 border-t border-ink/10">
      <Container>
        <div className="grid grid-cols-12 gap-y-10 gap-x-8 items-end">
          <div className="col-span-12 md:col-span-8">
            ...
            <Lede className="mt-8">
              The engine is currently in private deployment for the Hated By
              Many music vertical. Partner integrations open Q4. If you are
              building a vertical that needs a real-time consequence substrate,
          ...
          <div className="col-span-12 md:col-span-4 bg-ink text-snow-50 p-8">
            ...
            <div className="font-display text-3xl mt-2">consequence.software</div>
